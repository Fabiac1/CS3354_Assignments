...
public class FindText {
    ...
    public static void main(String[] args){
        ...
        do{
            ...
            if (!foundIt)
                System.out.println("No match found for needle '" + strNeedle + "' in the haystack.");
            else
                System.out.println("There are " + counter + " matches for neddle '" + strNeedle + "' in the haystack.");
